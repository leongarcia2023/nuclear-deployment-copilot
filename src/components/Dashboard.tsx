...
import { DocumentCoverageCard } from "./DocumentCoverageCard";
    ...
    <main id="dashboard" className="bg-[#f4f1ea] px-5 py-10 sm:px-8">
      <div className="mx-auto max-w-5xl">
        <div className="mb-6">
          ...
          <p className="mt-2 text-lg leading-8 text-[#4a4842]">{profile.claimToIcMemo.firstPassIcMemo.decision}</p>
        ...
        <SourceCoverageCard coverage={profile.claimToIcMemo.sourceCoverage} />
        <DocumentCoverageCard coverage={profile.claimToIcMemo.documentCoverage} />
